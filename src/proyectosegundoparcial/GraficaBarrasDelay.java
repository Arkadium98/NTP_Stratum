...
public class GraficaBarrasDelay extends ApplicationFrame {
    ...
    public GraficaBarrasDelay(String title, ArrayList<DatoIndividual> arr) {
        super(title);
        stratArray = arr; /// <-----
    ...
    private static CategoryDataset createDataset() {
        ...
        for(DatoIndividual obj:stratArray){
            dataset.addValue(obj.Delay, Integer.toString(obj.Strat), obj.Nombre);
        }
    ...
    private static JFreeChart createChart(CategoryDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart(
            "Comparacion del Delay por Servidor",       // chart title
            "Categoria",               // domain axis label
            "Delay",                  // range axis label
            dataset,                     // data
